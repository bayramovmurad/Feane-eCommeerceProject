...
const Index = () => {
  ...
  return (
    <div className="flex flex-wrap items-center h-screen mb-16">
      <div className="relative md:flex-1 md:w-[60%] md:h-[60%] md:my-0 my-16 w-48 h-48 mx-auto">
        <Image src="/images/f1ec.png" alt="" layout="fill" objectFit="contain" />
      </div>
      <div className="md:flex-1 md:text-start text-center md:pr-20">
