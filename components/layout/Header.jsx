      ...
      <div className="container mx-auto text-white flex justify-between items-center h-full">
        ...
        >
          <ul className="flex gap-x-2 sm:flex-row flex-col items-center">
            ...
            <li className="px-[5px] py-[10px] uppercase hover:text-primary cursor-pointer">
              <Link href="/menu/Index">Menu</Link>
            </li>
            <li className="px-[5px] py-[10px] uppercase hover:text-primary cursor-pointer">
              <Link href="/about/Index">About</Link>
            </li>
            <li className="px-[5px] py-[10px] uppercase hover:text-primary cursor-pointer">
              <Link href="/reservation/Reservation">Book Table</Link>
            </li>
          </ul>
          {isMenuModal && (
            <button
        ...
        <div className="flex gap-x-4 items-center">
          ...
          <span className="w-4 h-4 p-2 text-[10px] grid place-content-center rounded-full bg-primary absolute -top-2 -right-3 text-black font-bold">
